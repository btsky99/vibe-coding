...
sources:
  ...
  - .ai_monitor/vibe-view/src/components/terminal/VoiceBar.tsx:70
...
> 자동 합성 (코드 주석 48건 · 파일 6개 · 세션 메모리 2장 · 추출 55d5cf1).
...
출처: `.ai_monitor/vibe-view/src/components/terminal/VoiceBar.tsx:70`
...
출처: `.ai_monitor/vibe-view/src/lib/voiceBus.ts:99`
...
출처: `.ai_monitor/vibe-view/src/lib/voiceBus.ts:133`
...
출처: `.ai_monitor/vibe-view/src/lib/voiceBus.ts:140`
...
출처: `.ai_monitor/vibe-view/src/lib/voiceBus.ts:167`
...
출처: `.ai_monitor/vibe-view/src/lib/voiceBus.ts:226`
...
출처: `.ai_monitor/vibe-view/src/lib/voiceBus.ts:283`
...
출처: `.ai_monitor/vibe-view/src/lib/voiceBus.ts:295`
...
출처: `.ai_monitor/vibe-view/src/lib/voiceBus.ts:331`
...
출처: `.ai_monitor/vibe-view/src/lib/voiceBus.ts:375`
...
출처: `.ai_monitor/vibe-view/src/lib/voiceBus.ts:423`
...
출처: `.ai_monitor/vibe-view/src/lib/voiceBus.ts:427`
...
출처: `.ai_monitor/vibe-view/src/lib/voiceBus.ts:453`
...
출처: `.ai_monitor/vibe-view/src/lib/voiceBus.ts:512`
...
출처: `.ai_monitor/vibe-view/src/lib/voiceBus.ts:627`
...
출처: `.ai_monitor/vibe-view/src/lib/voiceBus.ts:674`
...
출처: `.ai_monitor/vibe-view/src/lib/voiceBus.ts:696`
...
출처: `.ai_monitor/vibe-view/src/lib/voiceBus.ts:813`
...
출처: `.ai_monitor/vibe-view/src/lib/voiceBus.ts:830`
...
출처: `.ai_monitor/vibe-view/src/lib/voiceBus.ts:877`
...
출처: `.ai_monitor/voice-server/voice_server.py:56`
...
출처: `.ai_monitor/voice-server/voice_server.py:65`
...
출처: `.ai_monitor/voice-server/voice_server.py:74`
...
출처: `.ai_monitor/voice-server/voice_server.py:174`
...
출처: `.ai_monitor/voice-server/voice_server.py:197`
...
출처: `.ai_monitor/voice-server/voice_server.py:219`
...
출처: `.ai_monitor/voice-server/voice_server.py:230`
