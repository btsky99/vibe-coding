...
> 자동 생성: `python scripts/generate_project_map.py` | 2026-07-05 23:10
...
| 파일 | 줄 수 | 설명 |
|------|------|------|
| `server.py` | 3597 | 중앙 HTTP 서버 (모든 API 라우팅, SSE, PostgreSQL 연동) |
