...
- **`.ai_monitor/bin/dashboard_native.py`**: [Windows Native] pywebview로 로컬 웹 UI를 감싼 데스크톱 대시보드 셸.
- **`.ai_monitor/src/native_dashboard.html`**: [Embedded Web UI] 네이티브 셸 내부에서 표시되는 HTML 기반 대시보드 프로토타입.
