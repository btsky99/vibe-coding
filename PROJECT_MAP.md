...
> 자동 생성: `python scripts/generate_project_map.py` | 2026-05-02 17:22
...
| 파일 | 줄 수 | 설명 |
|------|------|------|
| `server.py` | 4912 | 중앙 HTTP 서버 (모든 API 라우팅, SSE, PostgreSQL 연동) |
...
| `logger.py` | 123 |  |
| `pg_store.py` | 2476 | PostgreSQL 데이터 저장소 (스키마 관리 + 쿼리) |
| `secure.py` | 52 |  |
| `server_utils.py` | 59 |  |
| `view.py` | 243 |  |
