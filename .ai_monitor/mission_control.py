"""
FILE: .ai_monitor/mission_control.py
DESCRIPTION: AI 에이전트 전용 네이티브 윈도우 관제 센터 (Mission Control) — 시스템 트레이 및 사이드바 HUD 관리.

REVISION HISTORY:
- 2026-07-16 Claude: [9차 정리] 죽은 kanban 분기 제거 — kanban_board.py는 B안 통합(2026-03-13)으로
  이미 삭제된 파일이라 ImportError 가드가 항상 None → 메뉴/--kanban 경로가 영구 미실행 코드였음.
