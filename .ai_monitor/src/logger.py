# ────────────────────────────────────────────────────────────────────────────
# 📄 파일명: src/logger.py
# 📝 설명: 작업 세션 로깅 진입점. log_start()가 session_id 발급 + 민감정보 마스킹
#          (secure) 후 db_helper.insert_log로 기록. config.json 로드 담당.
# 🕒 변경 이력:
# [2026-07-18] Claude — 헤더 누락 보강 (코드 품질 점검 규칙 5 준수) +
#   sessions.jsonl 죽은 상수 제거. 로깅은 100% insert_log→PostgreSQL 단일 경로.
# ────────────────────────────────────────────────────────────────────────────
import os
import sys
import json
