...
VOICES = [
    {
        'id': 'moss:apix',
        'label': '아픽스 나노 (사장님 목소리 · 첫 소리 0.7초)',
        'engine': 'moss',
        'lang': 'ko',
        # [🔴 화면 기준 값을 적는다 — 2026-08-17 실측] 0.2초는 **일꾼 안에서** 소리가
        #   만들어지는 시점이다. 사장 귀에 닿는 값은 /tts/seq 첫 조각이 앱에 도착하는
        #   시점이고, 예열된 상태에서 0.66~0.98초였다(같은 글 2회). 라벨이 일꾼 안 값을
        #   말하면 사장이 고르실 때 보는 숫자가 실제와 어긋난다.
        'note': '첫 소리가 빠릅니다(화면 기준 0.7초). 긴 글 전체 속도는 Qwen 이 빠릅니다',
    },
]
