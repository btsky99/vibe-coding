...
### [ ] Task 3: GEMINI.md 내용 Antigravity 기준 갱신 (rename 취소 — 실측 반영)
...
### [ ] Task 4: scripts/ gemini_* 파일 5종 rename + 참조 갱신
...
### [ ] Task 5: scripts/ 식별자 교체 ('gemini'→'antigravity')
