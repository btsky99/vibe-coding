...
REVISION HISTORY:
- 2026-08-19 Claude: 0장 신설 — docs/HANDOVER.md(인수인계) 진입점. 자동 로드되는 파일이
...
> **[`docs/HANDOVER.md`](docs/HANDOVER.md) — 지금 어디까지 왔나 · 지금 막힌 것 ·
> 🔴 이미 해 봤는데 아니었던 것.**
...
아래 10개는 **세부 규칙 파일을 읽지 않아도** 항상 적용된다. 위반이 감지되면 진행 전에 반드시 수정한다.
