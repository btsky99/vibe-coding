...
_INTENT_MAP = [
    {
        ...
        "context": (
            "═══════════════════════════════════════════════════════\n"
            "🏗️  [자동 감지] 빌드 워크플로 — Windows EXE 빌드\n"
            "═══════════════════════════════════════════════════════\n"
            "프로젝트: D:\\vibe-coding\n"
            "\n"
            "【빌드 순서 — 반드시 이 순서대로】\n"
            ...
            "  → dist/vibe-coding.exe 생성 (단일 파일 EXE)\n"
            "\n"
            "⚠️  Step 1 먼저 실행 후 Step 2 실행 — 순서 변경 시 구 버전 UI 포함됨\n"
            "═══════════════════════════════════════════════════════"
        ),
    },
    {
    ...
    },
    {
        ...
        "context": (
            "═══════════════════════════════════════════════════════\n"
            "🔍  [자동 감지] 코드 리뷰 워크플로 → /vibe-code-review\n"
            "═══════════════════════════════════════════════════════\n"
            "4가지 관점으로 검토:\n"
            "1) 코드 품질 — 가독성, 중복, 복잡도\n"
            "2) 보안 — OWASP Top 10, 인젝션, 노출\n"
            "3) 성능 — 병목, 불필요 연산, 메모리\n"
            "4) 설계 — 단일책임, 결합도, 확장성\n"
            "═══════════════════════════════════════════════════════"
        ),
    },
    {
        ...
        "context": (
            "═══════════════════════════════════════════════════════\n"
            "🐛  [자동 감지] 디버그 워크플로 → /vibe-debug\n"
            "═══════════════════════════════════════════════════════\n"
            "4단계 분석:\n"
            "1) 증상 파악 — 실제 vs 기대 동작 비교\n"
            "2) 원인 추적 — 스택, 로그, 코드 역추적\n"
            "3) 수정 — 근본 원인 제거 (증상 아님)\n"
            "4) 검증 — 수정 후 재현 불가 확인\n"
            "═══════════════════════════════════════════════════════"
        ),
    },
    {
        ...
        "context": (
            "═══════════════════════════════════════════════════════\n"
            "🧪  [자동 감지] 테스트 워크플로 → /vibe-tdd\n"
            "═══════════════════════════════════════════════════════\n"
            "RED → GREEN → REFACTOR 사이클\n"
            "Python 테스트: python -m pytest\n"
            "프론트엔드 타입 체크: cd .ai_monitor/vibe-view && npx tsc --noEmit\n"
            "═══════════════════════════════════════════════════════"
        ),
    },
    {
